...
const vehicles: [string, string, number][] = [
  ['001', 'A-001-BC', 1200],
  ['002', 'B-002-CD', 1500],
  ['003', 'C-003-DE', 2000],
  ['004', 'D-004-EF', 1800],
...
const vehicleLocations: [string, [number, number]][] = [
  ['001', [40.7128, -74.0060]],
...
function getHumanFriendlyVehicleLocations(vehicles: [string, string, number][], vehicleLocations: [string, [number, number]][]): string[] {
